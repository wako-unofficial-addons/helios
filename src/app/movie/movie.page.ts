...
@Component({
    ...
    standalone: true,
    imports: [PlaylistListComponent, IonHeader, IonToolbar, IonTitle, IonContent, IonHeader, IonToolbar, IonTitle, IonContent, IonHeader, IonToolbar, IonTitle, IonContent]
})
