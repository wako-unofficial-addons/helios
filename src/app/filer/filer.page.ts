...
import { arrowBackSharp, homeOutline, refreshOutline, folderOpenOutline, documentOutline, trashOutline } from "ionicons/icons";
import { IonHeader, IonToolbar, IonButtons, IonButton, IonIcon, IonTitle, IonSpinner, IonContent, IonList, IonListHeader, IonLabel, IonItemSliding, IonItem, IonItemOptions, IonItemOption } from "@ionic/angular/standalone";
...
@Component({
    ...
    standalone: true,
    imports: [NgIf, NgFor, IonHeader, IonToolbar, IonButtons, IonButton, IonIcon, IonTitle, IonSpinner, IonContent, IonList, IonListHeader, IonLabel, IonItemSliding, IonItem, IonItemOptions, IonItemOption, IonHeader, IonToolbar, IonButtons, IonButton, IonIcon, IonTitle, IonSpinner, IonContent, IonList, IonListHeader, IonLabel, IonItemSliding, IonItem, IonItemOptions, IonItemOption, IonHeader, IonToolbar, IonButtons, IonButton, IonIcon, IonTitle, IonSpinner, IonContent, IonList, IonListHeader, IonLabel, IonItemSliding, IonItem, IonItemOptions, IonItemOption]
})
