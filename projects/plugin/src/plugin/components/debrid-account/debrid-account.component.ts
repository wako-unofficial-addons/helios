...
import { AlertController, IonCard, IonCardHeader, IonCardTitle, IonSpinner, IonCardContent, IonText, IonList, IonItem, IonLabel, IonToggle } from '@ionic/angular/standalone';
...
@Component({
    ...
    standalone: true,
    imports: [NgIf, FormsModule, TranslateModule, IonCard, IonCardHeader, IonCardTitle, IonSpinner, IonCardContent, IonText, IonList, IonItem, IonLabel, IonToggle],
})
