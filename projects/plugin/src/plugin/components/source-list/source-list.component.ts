...
import { ModalController, IonProgressBar, IonCard, IonCardHeader, IonCardTitle, IonCardContent, IonSegment, IonSegmentButton, IonLabel, IonSearchbar, IonList, IonListHeader, IonItem, IonItemSliding, IonText, IonNote, IonBadge, IonItemOptions, IonItemOption, IonIcon, IonSpinner } from '@ionic/angular/standalone';
