...
import { PopoverController, IonToolbar, IonSearchbar, IonButtons, IonButton, IonIcon, IonItem, IonLabel, IonSelect, IonSelectOption } from '@ionic/angular/standalone';
...
@Component({
    ...
    standalone: true,
    imports: [HideKeyboardEnterDirective, NgIf, FormsModule, SourceListComponent, TranslateModule, IonToolbar, IonSearchbar, IonButtons, IonButton, IonIcon, IonItem, IonLabel, IonSelect, IonSelectOption],
})
